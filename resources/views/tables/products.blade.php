                ...
                <table id="range-search" class="display table table-hover" style="width:100%">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><div class="avatar avatar-xl"><img src="{{ asset('storage/materials/' . $products[$i]->photo) }}" alt="a" width="90" height="90" class="rounded-circle"></div></td></td>
                            <td>{{$products[$i]->name}}</td>
                            <td style="width: 200px">{{$products[$i]->description}}</td>
