                            ...
                            <div class="invoice-container">
                                <div class="invoice-inbox">
                                    ...
                                    @foreach($invoices as $invoice)
                                        ...
                                        <div id="invoice-{{$invoice->id}}" class="invoice-{{$invoice->id}}">
                                            ...
                                            <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                ...
                                                <div class="row inv--detail-section">
                                                    ...
                                                    <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                        <p class="inv-list-number"><span class="inv-title">Invoice Number : </span> <span class="inv-number">{{$invoice->id}}</span></p>
                                                        ...
                                                        <div class="inv--payment-info">
                                                            <div class="row">
                                                                ...
                                                                {{-- <div class="col-sm-4 col-12">
                                                                    <p class=" inv-subtitle">{!! $client->is_company ? 'MF:{{$clients->cin}}': 'CIN:{{$clients->$client->cin}}' !!}</p>
                                                                </div> --}}
                                                        
                                                                <div class="col-sm-4 col-12">
                                                                    <p class=" inv-subtitle">CIN/MF: </p>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-7 col-12 order-sm-1 order-0">
                                                        <div class="inv--total-amounts text-sm-right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8 col-7">
                                                                    <p class="">Tax Amount: {{$invoice->tax}} </p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">$700</p>
                                                                </div>
                                                                <div class="col-sm-8 col-7">
                                                                    <p class=" discount-rate">Discount : <span class="discount-percentage">{{$invoice->discount}}</span> </p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">$700</p>
                                                                </div>
