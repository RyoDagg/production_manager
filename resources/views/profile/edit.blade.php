                ...
                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-12 col-md-4">
                                                <div class="upload mt-4 pr-md-4">
                                                    <input type="file" id="input-file-max-fs" class="dropify" style="width:72%;" data-default-file="{{ asset('storage/users/' . auth()->user()->avatar) }}" data-max-file-size="2M" />
                                            ...
                                            <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                <div class="form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" id="profession" placeholder="Enter Your Address">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="profession">Email</label>
                                                        <input type="email" class="form-control mb-4" id="profession" placeholder="Enter Your Email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="profession">Phone Number</label>
                                                        <input type="number" class="form-control mb-4" id="profession" placeholder="Enter Your Phone Number">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="profession">Cnss Number</label>
                                                        <input type="number" class="form-control mb-4" id="profession" placeholder="Enter Your Cnss Number">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="reset" type="reset" name="reset" class="btn btn-warning">Reset All</button>
