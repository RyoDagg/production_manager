        ...
        <div class="modal-content">
            ...
            <div class="row mb-3 mx-1">
                <div class="col text-left mx-3">
                    <a data-dismiss="modal" data-toggle="modal" href="#productModal"
                        class="btn btn-primary mb-2 mr-2 btn-rounded">
...
<div class="modal animated fade custo-fade register-modal" id="infomodal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="infomodalLabel">
                <h4 class="modal-title text-primary">Add Product's Materials</h4>
                <a type="button" class="close" data-dismiss="modal" data-toggle="modal" href="#productModal"
                    aria-hidden="true">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-x">
